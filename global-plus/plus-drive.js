...
(function(){
  ...
  const FILE_NAME = cfg.DRIVE_FILE_NAME || (COUNTRY && COUNTRY !== "AR" ? `puntosmart-config-${COUNTRY}.json` : "puntosmart-config.json");
  ...
  function applyConfig(data){
    ...
    if(Array.isArray(data.custom)){
      localStorage.setItem(LS_CUSTOM_TILES, JSON.stringify(data.custom));
    }
